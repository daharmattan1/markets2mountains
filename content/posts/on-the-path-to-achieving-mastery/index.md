---
title: "On The Path To Achieving Mastery"
date: 2019-01-16
draft: false
summary: "Achieving mastery requires some uncommon things. That’s obvious enough, if it were simple and common, there would be many more masters."
tags:
  - path
  - achieving
  - mastery
...
<blockquote>
<p style="text-align: center;">"All things excellent are as difficult as they are rare"

<p style="text-align: center;">-Spinoza
...
<ul>
	<li>A roadmap</li>
	<li>A system</li>
	<li>A mentor / feedback</li>
	<li>An embrace of the path</li>
	<li>Removal of ego</li>
</ul>
...
[![mastery-curve](/images/mastery-curve.png)](/images/mastery-curve.png)
...
<ul>
	<li>Find and understand your motivation/purpose</li>
	<li>Embrace learning, seek a teacher</li>
	<li>Lean into the process, for that is all there is</li>
	<li>Push through resistance, it’s a sign you’re on the path</li>
	<li>Stay humble</li>
</ul>