---
title: "It Ain't All Talk - Principles of Team Communication"
date: 2018-08-18
draft: false
summary: "It's a truism that communication is vital to a team's success."
tags:
  - talk
  - principles
  - team
...
This post summarizes a presentation I gave to around 25 managers at [CB Insights](cbinsights.com) last year which aimed at underscoring how important establishing a common language is within a team (and company). Because if your team can't communicate, it can't get things done.
<!--more-->
<h1>There's a lot of communicating around here</h1>
...
<ul>
	<li>You to one</li>
	<li>One to you</li>
	<li>One to your boss</li>
	<li>You to many</li>
	<li>Many to you</li>
	<li>Many to many, including you</li>
	<li>Many to many, not including you</li>
	<li>You about them</li>
	<li>Outside-the-team communication (outside of our scope for now)</li>
</ul>
...
[![team-communication](/images/team-communication.png)](/images/team-communication.png)

A team of two has a much easier time communicating and staying on the same page as a team of 6, which is likely one of the principles at the root of [Bezos's two pizza rule](https://blog.bufferapp.com/small-teams-why-startups-often-win-against-google-and-facebook-the-science-behind-why-smaller-teams-get-more-done) and other manager truisms about small teams moving faster and accomplishing more than larger teams.

There are two obvious but non-trivial truths that flow from this that you need to remain aware of as your team grows:
<ul>
	<li>First, there are more lines of communication in which you are not directly involved (and thus the more important the 'framework/culture' become</li>
	<li>Second, you should expect to spend a proportionally larger and larger percent of your time on communication. If your team grows 2x your communication work and overhead might grow 3 or 4x</li>
</ul>
...
[![victor-preferences](/images/victor-preferences.png)](/images/victor-preferences.png)
...
<ul>
	<li>Organically</li>
	<li>Through the overarching culture of the team</li>
	<li>Via explicit meta-conversations about conversations</li>
</ul>
...
It's helpful (I think) for my team to know I am an [ENTJ ](https://www.truity.com/personality-type/ENTJ)who thinks he is a shade less extroverted than most "Es" which give me a healthy doze of [INTJ](https://www.truity.com/personality-type/INTJ) too. Recently we used the Gallups Strengthsfinder to have a fun two hour "onsite" about how we, as a team, have very different strengths and blind spots.
...
[![team-gallup](/images/team-gallup.png)](/images/team-gallup.png)

Our round table covered questions like:
<ul>
	<li>Did any of the results or descriptions surprise you?</li>
	<li>What do you think that means in terms of your strengths and weaknesses?</li>
	<li>What communication challenges do these different styles represent?</li>
	<li>How can we leverage our differences in a positive way?</li>
</ul>
...
[![team-comm_cartoon](/images/team-comm_cartoon.png)](/images/team-comm_cartoon.png)
...
<ul>
	<li>Collect feedback and gather information</li>
	<li>Give coaching or work through "thorny" issues</li>
	<li>Re-calibrate around important, but often not urgent, issues</li>
...
<ul>
	<li>Deliver the feedback as close to real time as possible</li>
	<li>In private</li>
	<li>Remember that tough feedback is not negative feedback. Your intent matters</li>
	<li>Your team already knows and NOT giving feedback will bleed through those web of interactions you can't control</li>
	<li>You can use "can I give you some feedback" to prime the person that this is coming</li>
	<li>Avoid the [sh*t sandwich ](https://www.urbandictionary.com/define.php?term=Shit%20Sandwich)</li>
	<li>Your stars need this feedback as much, or more, than anyone</li>
</ul>
Some of this is definitely wrapped up in the Silicon Valley buzzword around radical candor ([article 1](http://firstround.com/review/radical-candor-the-surprising-secret-to-being-a-good-boss/) and [article 2](http://firstround.com/review/on-receiving-and-truly-hearing-radical-candor/) discussing that):

[![radical-candor](/images/radical-candor.png)](/images/radical-candor.png)

This [HBR article](https://hbr.org/topic/giving-feedback) gives a nice list of additional reading.
## One Team, One Dream
...
<ul>
	<li>**Mission - **Why are we here</li>
	<li>**Vision - **Where do we want to get to</li>
	<li>**Strategy - **How are we going to get there</li>
</ul>
One of the tools my [executive coach](https://www.linkedin.com/in/swatiddoshi/) left me with was a quick framework for facilitating this discussion with the team:

[![mission-vision](/images/mission-vision.png)](/images/mission-vision.png)
...
<ul>
	<li>“Instill the right way”</li>
	<li>“Set (others) up for success”</li>
	<li>Educate</li>
	<li>Keep it real</li>
	<li>Be the “oil in the machine”</li>
	<li>“Remove friction”</li>
	<li>Get sh*t done</li>
	<li>Turn vision into reality</li>
	<li>Unlock new sources of growth</li>
</ul>
...
[![mission-vision_revops](/images/mission-vision_revops-e1534620490319.png)](/images/mission-vision_revops-e1534620490319.png)
...
[![job-description_comms](/images/job-description_comms-e1534621269327.png)](http://markets2mountains.com/wp-content/uploads/2018/08/job-description_comms.png)
...
<ul>
	<li>Working in two-week sprints - The Agile framework has shaped a lot of how we approach our work and talk about prioritization and project planning</li>
	<li>Having a bi-weekly learning meeting - Twice a month someone on the team teaches something</li>
	<li>Offsites - Take a lot of planning, but when executed well are very powerful</li>
	<li>Daily Standups - We do two of these a week live, one on Hipchat/Slack, and one weekly recap check-in</li>
	<li>Getting out of the office</li>
	<li>Start-stop-continue is a powerful check-in</li>
</ul>
I talk much more about these in my [tactical tips for managers post](http://markets2mountains.com/tactical-tips-for-new-managers/).
